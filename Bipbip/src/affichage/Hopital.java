...
public class Hopital {
	...
	public void initialisation() {
		...
		murs.add(new Wall(mEH1, mEH2, 5, null, "mEH1", te, tpC09));
		murs.add(new Wall(mEH2, mEH3, 5, null, "mEH2", te, tpC08));
		murs.add(new Wall(mEH3, mEH4, 5, null, "mEH3", te, tpC07));
		murs.add(new Wall(mEH4, mEH5, 5, null, "mEH4", te, tpC06));
		murs.add(new Wall(mEH5, mEH6, 5, null, "mEH5", te, tpC05));
		murs.add(new Wall(mEH6, mEH7, 5, null, "mEH6", te, tpD01));
		murs.add(new Wall(mEH7, mEH8, 5, null, "mEH7", te, tpC04));
		murs.add(new Wall(mEH8, mEH9, 5, null, "mEH8", te, tpC03));
		murs.add(new Wall(mEH9, mEH10, 5, null, "mEH9", te, tpC02));
		murs.add(new Wall(mEH10, mEH11, 5, null, "mEH10", te, tpC01));
		murs.add(new Wall(mEH11, mEH12, 5, null, "mEH11", te, tpD02));
		...
		murs.add(new Wall(mEH14, mED1, 5, null, "mED1", te, tpD04));
		murs.add(new Wall(mED1, mED2, 5, null, "mED2", te, tc));
		murs.add(new Wall(mED2, mED3, 5, null, "mED3", te, tpINF));
		murs.add(new Wall(mED3, mED4, 5, null, "mED4", te, tpINF));
		...
		murs.add(new Wall(mED4, mEB1, 5, null, "mEB1", te, tpINF));
		murs.add(new Wall(mEB1, mEB2, 5, null, "mEB2", te, tpD05));
		murs.add(new Wall(mEB2, mEB3, 5, null, "mEB3", te, tpD06));
		murs.add(new Wall(mEB3, mEB4, 5, null, "mEB4", te, tc));
		murs.add(new Wall(mEB4, mEB5, 5, null, "mEB5", te, tpD07));
		murs.add(new Wall(mEB5, mEB6, 5, null, "mEB6", te, tpC18));
		murs.add(new Wall(mEB6, mEB7, 5, null, "mEB7", te, tpC17));
		murs.add(new Wall(mEB7, mEB8, 5, null, "mEB8", te, tpC16));
		murs.add(new Wall(mEB8, mEB9, 5, null, "mEB9", te, tpC15));
		murs.add(new Wall(mEB9, mEB10, 5, null, "mEB10", te, tpC14));
		murs.add(new Wall(mEB10, mEB11, 5, null, "mEB11", te, tpC13));
		...
		murs.add(new Wall(mEB12, mEG1, 5, null, "mEG1", te, tpC12));
		murs.add(new Wall(mEG1, mEG2, 5, null, "mEG2", te, tc));
		murs.add(new Wall(mEG2, mEG3, 5, null, "mEG3", te, tpD08));
		murs.add(new Wall(mEG3, mEG4, 5, null, "mEG4", te, tc));
		murs.add(new Wall(mEG4, mEG5, 5, null, "mEG5", te, tpC10));
		murs.add(new Wall(mEG5, mEG6, 5, null, "mEG6", te, tpC11));
		murs.add(new Wall(mEG6, mEG7, 5, null, "mEG7", te, tc));
		...
		murs.add(new Wall(mEG7, pIH1, 2, porteC09, "mIH1", tpC09, tc));
		murs.add(new Wall(pIH1, mEH2, 2, null, "mIH2", tpC09, tpC08));
		murs.add(new Wall(pIH1, pIH2, 2, porteC08, "mIH3", tpC08, tc));
		murs.add(new Wall(pIH2, mEH3, 2, null, "mIH4", tpC08, tpC07));
		murs.add(new Wall(pIH2, pIH3, 2, porteC07, "mIH5", tpC07, tc));
		murs.add(new Wall(pIH3, mEH4, 2, null, "mIH6", tpC07, tpC06));
		murs.add(new Wall(pIH3, pIH4, 2, porteC06, "mIH7", tpC06, tc));
		murs.add(new Wall(pIH4, mEH5, 2, null, "mIH8", tpC06, tpC05));
		murs.add(new Wall(pIH4, pIH5, 2, porteC05, "mIH9", tpC05, tc));
		murs.add(new Wall(pIH5, mEH6, 2, null, "mIH10", tpC05, tpD01));
		murs.add(new Wall(pIH5, pIH6, 2, porteD01, "mIH11", tpD01, tc));
		murs.add(new Wall(pIH6, mEH7, 2, null, "mIH12", tpD01, tpC04));
		murs.add(new Wall(pIH6, pIH7, 2, porteC04, "mIH13", tpC04, tc));
		murs.add(new Wall(pIH7, mEH8, 2, null, "mIH14", tpC04, tpC03));
		murs.add(new Wall(pIH7, pIH8, 2, porteC03, "mIH15", tpC03, tc));
		murs.add(new Wall(pIH8, mEH9, 2, null, "mIH16", tpC03, tpC02));
		murs.add(new Wall(pIH8, pIH9, 2, porteC02, "mIH17", tpC02, tc));
		murs.add(new Wall(pIH9, mEH10, 2, null, "mIH18", tpC02, tpC01));
		murs.add(new Wall(pIH9, pIH10, 2, porteC01, "mIH19", tpC01, tc));
		murs.add(new Wall(pIH10, mEH11, 2, null, "mIH20", tpC01, tpD02));
		murs.add(new Wall(pIH10, pIH11, 2, porteD02, "mIH21", tpD02, tc));
		murs.add(new Wall(pIH11, mEH12, 2, null, "mIH22", tpD02, tpD03));
		murs.add(new Wall(pIH11, pIH12, 2, porteD03, "mIH23", tpD03, tc));
		murs.add(new Wall(pIH12, mEH13, 2, null, "mIH24", tpD03, tpD04));
		murs.add(new Wall(pIH12, mED1, 2, porteD04, "mIH25", tpD04, tc));
		...
		murs.add(new Wall(pIG1, mEG2, 2, null, "mIG7", tc, tpD08));
		...
		murs.add(new Wall(pIGH1, pIGH2, 2, porteD09, "mIGH1", tc, tpD09));
		murs.add(new Wall(pIGH2, pIGH9, 2, null, "mIGH2", tpD10, tpD09));
		//bug
		murs.add(new Wall(pIGH3, pIGH2, 2, porteD10, "mIGH3", tpD10, tc));
		murs.add(new Wall(pIGH3, pIGH8, 2, null, "mIGH4", tpD11, tpD10));
		murs.add(new Wall(pIGH3, pIGH4, 2, porteD11, "mIGH5", tc, tpD11));
		murs.add(new Wall(pIGH4, pIGH7, 2, null, "mIGH6", tpD12, tpD11));
		//
		murs.add(new Wall(pIGH5, pIGH4, 2, null, "mIGH7", tpD12, tc));
		murs.add(new Wall(pIGH5, pIGH6, 2, porteD12, "mIGH8", tc, tpD12));
		murs.add(new Wall(pIGH6, pIGB6, 2, null, "mIGH9", tc, tc));
		murs.add(new Wall(pIGH6, pIGH7, 2, null, "mIGH10", tc, tpD12));
		murs.add(new Wall(pIGH7, pIGH8, 2, null, "mIGH11", tc, tpD11));
		murs.add(new Wall(pIGH8, pIGH9, 2, null, "mIGH12", tc, tpD10));
		murs.add(new Wall(pIGH9, pIGH10, 2, null, "mIGH13", tc, tpD09));
		murs.add(new Wall(pIGH10, pIGH1, 2, null, "mIGH14", tc, tpD09));
			
		murs.add(new Wall(pIGH10, pIGB1, 2, null, "mIGB1", tc, tc));
		murs.add(new Wall(pIGB1, pIGB2, 2, null, "mIGB2", tc, tpD13));
		murs.add(new Wall(pIGB2, pIGB11, 2, null, "mIGB3", tpD14, tpD13));
		murs.add(new Wall(pIGB2, pIGB3, 2, null, "mIGB4", tc, tpD14));
		murs.add(new Wall(pIGB3, pIGB10, 2, porteD15, "mIGB5", tpD15, tpD14));
		murs.add(new Wall(pIGB3, pIGB4, 2, null, "mIGB6", tc, tpD15));
		murs.add(new Wall(pIGB4, pIGB9, 2, null, "mIGB7", tpD16, tpD15));
		murs.add(new Wall(pIGB4, pIGB5, 2, null, "mIGB8", tc, tpD16));
		murs.add(new Wall(pIGB5, pIGB8, 2, null, "mIGB9", tpD17, tpD16));
		murs.add(new Wall(pIGB5, pIGB6, 2, null, "mIGB10", tc, tpD17));
		//
		murs.add(new Wall(pIGB7, pIGB6, 2, porteD17, "mIGB11", tpD17, tc));
		murs.add(new Wall(pIGB7, pIGB8, 2, null, "mIGB12", tc, tpD17));
		//
		murs.add(new Wall(pIGB9, pIGB8, 2, porteD16, "mIGB13", tpD16, tc));
		murs.add(new Wall(pIGB9, pIGB10, 2, null, "mIGB14", tc, tpD15));
		//
		murs.add(new Wall(pIGB11, pIGB10, 2, porteD14, "mIGB15", tpD14, tc));
		murs.add(new Wall(pIGB11, pIGB12, 2, porteD13, "mIGB16", tc, tpD13));
		murs.add(new Wall(pIGB12, pIGB1, 2, null, "mIGB17", tc, tpD13));
		...
		murs.add(new Wall(pIDH1, pIDH2, 2, null, "mIDH1", tc, tpD18));
		murs.add(new Wall(pIDH2, pIDH3, 2, null, "mIDH2", tc, tpD18));
		murs.add(new Wall(pIDH3, pIDH4, 2, null, "mIDH3", tc, tpD18));
		murs.add(new Wall(pIDH4, pIDH5, 2, porteD18, "mIDH4", tc, tpD18));
		murs.add(new Wall(pIDH5, pIDH6, 2, null, "mIDH5", tc, tpD18));
		murs.add(new Wall(pIDH6, pIDH11, 2, null, "mIDH6", tpD20, tpD18));
		murs.add(new Wall(pIDH6, pIDH7, 2, porteD20, "mIDH7", tc, tpD20));
		murs.add(new Wall(pIDH7, pIDH8, 2, null, "mIDH8", tc, tpD20));
		murs.add(new Wall(pIDH8, pIDH11, 2, null, "mIDH9", tpD19, tpD20));
		//
		murs.add(new Wall(pIDH9, pIDH8, 2, null, "mIDH10", tpD19, tc));
		//
		murs.add(new Wall(pIDH10, pIDH9, 2, porteD19, "mIDH11", tpD19, tc));
		murs.add(new Wall(pIDH10, pIDH11, 2, null, "mIDH12", tpD18, tpD19));
		murs.add(new Wall(pIDH10, pIDH1, 2, null, "mIDH13", tc, tpD18));
		...
		murs.add(new Wall(pIDB1, pIDB2, 2, null, "mIDB1", tc, tpD21));
		murs.add(new Wall(pIDB2, pIDB3, 2, null, "mIDB2", tc, tpD22));
		murs.add(new Wall(pIDB3, pIDB4, 2, null, "mIDB3", tc, tpD22));
		murs.add(new Wall(pIDB4, pIDB5, 2, null, "mIDB4", tc, tpD22));
		murs.add(new Wall(pIDB5, pIDB6, 2, porteD24, "mIDB5", tc, tpD24));
		murs.add(new Wall(pIDB6, pIDB7, 2, porteD23, "mIDB6", tc, tpD23));
		murs.add(new Wall(pIDB7, pIDB8, 2, null, "mIDB7", tc, tpD23));
		murs.add(new Wall(pIDB8, pIDB1, 2, porteD21, "mIDB8", tc, tpD21));
		murs.add(new Wall(pIDB2, pIDB10, 2, null, "mIDB9", tpD22, tpD21));
		murs.add(new Wall(pIDB10, pIDB5, 2, null, "mIDB10", tpD22, tpD24));
		murs.add(new Wall(pIDB10, pIDB9, 2, null, "mIDB11", tpD24, tpD21));
		murs.add(new Wall(pIDB9, pIDB6, 2, null, "mIDB12", tpD24, tpD23));
		murs.add(new Wall(pIDB9, pIDB8, 2, null, "mIDB13", tpD23, tpD21));
		...
		murs.add(new Wall(pID1, pID2, 2, porteD25, "mID1", tpD25, tc));
		murs.add(new Wall(pID2, pID13, 2, null, "mID2", tpD25, tpD26));
		murs.add(new Wall(pID2, pID3, 2, porteD26, "mID3", tpD26, tc));
		murs.add(new Wall(pID3, pID6, 2, null, "mID4", tpD26, tc));
		murs.add(new Wall(pID3, pID4, 2, null, "mID5", tc, tc));
		murs.add(new Wall(pID4, pID5, 2, null, "mID6", tc, tc));
		murs.add(new Wall(pID5, pID6, 2, null, "mID7", tc, tc));
		murs.add(new Wall(pID6, pID7, 2, null, "mID8", tpD26, tc));
		murs.add(new Wall(pID7, pID13, 2, null, "mID9", tpD26, tc));
		murs.add(new Wall(pID7, pID8, 2, null, "mID10", tc, tc));
		murs.add(new Wall(pID8, pID9, 2, null, "mID11", tc, tc));
		murs.add(new Wall(pID9, pID10, 2, null, "mID12", tc, tc));
		murs.add(new Wall(pID10, pID11, 2, null, "mID13", tc, tc));
		murs.add(new Wall(pID11, pID13, 2, null, "mID14", tc, tpD25));
		murs.add(new Wall(pID11, pID12, 2, null, "mID15", tpD25, tc));
		murs.add(new Wall(pID12, pID1, 2, null, "mID16", tpD25, tc));
		...
		murs.add(new Wall(pII1, pII2, 2, porteD27, "mII1", tc, tpD27));
		murs.add(new Wall(pII2, pII3, 2, null, "mII2", tc, tc));
		murs.add(new Wall(pII1, pII4, 2, null, "mII3", tpD27, tc));
		murs.add(new Wall(pII2, pII6, 2, null, "mII4", tc, tpD27));
		murs.add(new Wall(pII3, pII8, 2, null, "mII5", tc, tc));
		murs.add(new Wall(pII4, pII5, 2, null, "mII6", tpD27, tpD28));
		murs.add(new Wall(pII5, pII6, 2, null, "mII7", tpD27, tpD29));
		murs.add(new Wall(pII6, pII7, 2, null, "mII8", tc, tpD29));
		murs.add(new Wall(pII7, pII8, 2, null, "mII9", tc, tpINF));
		murs.add(new Wall(pII8, mED2, 2, porteINF, "mII10", tc, tpINF));
		murs.add(new Wall(pII4, pII9, 2, null, "mII11", tpD28, tc));
		murs.add(new Wall(pII5, pII10, 2, null, "mII12", tpD29, tpD28));
		murs.add(new Wall(pII7, pII11, 2, null, "mII13", tpINF, tpD29));
		//TODO : bug inversion point
		murs.add(new Wall(pII10, pII9, 2, null, "mII14", tc, tpD28));
		murs.add(new Wall(pII10, pII11, 2, porteD29, "mII15", tpD29, tc));
		murs.add(new Wall(mEB3, pII12, 2, null, "mII16", tc, tpD06));
		murs.add(new Wall(pII12, pII13, 2, porteD06, "mII17", tc, tpD06));
		murs.add(new Wall(pII13, pII14, 2, null, "mII18", tc, tpD06));
		murs.add(new Wall(pII14, mEB2, 2, null, "mII19", tpD05, tpD06));
		murs.add(new Wall(pII14, pII15, 2, porteD05, "mII20", tc, tpD05));
		murs.add(new Wall(pII15, pII11, 2, null, "mII21", tc, tpINF));
		murs.add(new Wall(pII15, mEB1, 2, null, "mII22", tpINF, tpD05));
		...
		murs.add(new Wall(mEG1, pIB1, 2, porteC12, "mIB1", tc, tpC12));
		murs.add(new Wall(pIB1, pIB2, 2, porteC13, "mIB2", tc, tpC13));
		murs.add(new Wall(pIB2, pIB3, 2, porteC14, "mIB3", tc, tpC14));
		murs.add(new Wall(pIB3, pIB4, 2, porteC15, "mIB4", tc, tpC15));
		murs.add(new Wall(pIB4, pIB5, 2, porteC16, "mIB5", tc, tpC16));
		murs.add(new Wall(pIB5, pIB6, 2, porteC17, "mIB6", tc, tpC17));
		murs.add(new Wall(pIB6, pIB7, 2, porteC18, "mIB7", tc, tpC18));
		murs.add(new Wall(pIB7, pIB8, 2, null, "mIB8", tc, tpD30));
		murs.add(new Wall(pIB8, pIB10, 2, porteD30, "mIB9", tc, tpD30));
		murs.add(new Wall(pIB10, mEB4, 2, null, "mIB10", tc, tpD07));
		murs.add(new Wall(pIB9, pIB7, 2, null, "mIB11", tpC18, tc));
		murs.add(new Wall(pIB9, pIB10, 2, null, "mIB12", tpD30, tpD07));
		murs.add(new Wall(pIB9, mEB5, 2, null, "mIB13", tpD07, tpC18));

		murs.add(new Wall(pIB1, mEB11, 2, null, "mIB10", tpC12, tpC13));
		murs.add(new Wall(pIB2, mEB10, 2, null, "mIB11", tpC13, tpC14));
		murs.add(new Wall(pIB3, mEB9, 2, null, "mIB12", tpC14, tpC15));
		murs.add(new Wall(pIB4, mEB8, 2, null, "mIB13", tpC15, tpC16));
		murs.add(new Wall(pIB5, mEB7, 2, null, "mIB10", tpC16, tpC17));
