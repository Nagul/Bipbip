...
public class Bipbip {
	...
	public static void main(String[] args) {
		...
		*/
		...
		murs.add(new Mur(pIG3, mEG5, 2, null, "mIG3", tpC10, tpC11));
		murs.add(new Mur(pIG3, pIG2, 2, porteC11, "mIG4", tc, tpC11));
		murs.add(new Mur(pIG2, mEG4, 2, null, "mIG5", tpC11, tpD08));
		...
		murs.add(new Mur(pII9, pII10, 2, null, "mII14", tpD28, tc));
